...
const quickActions = [
  { label: "Report Incident", desc: "Submit a new illegal fishing report", path: "/public/report", accent: "#22d3b0", icon: "◎" },
  { label: "My Reports", desc: "Track your submitted reports", path: "/public/my-reports", accent: "#0ea5e9", icon: "◉" },
